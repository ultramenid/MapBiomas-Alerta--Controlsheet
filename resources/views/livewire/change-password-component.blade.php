<div class="w-full">
    ...
    <div class="w-full gap-4 flex sm:flex-row flex-col mt-12 sm:justify-end">
        <button wire:click='storePassword' wire:loading.attr='disabled' class="bg-stone-900 dark:bg-slate-200 text-white dark:text-stone-900 py-2 px-4 text-sm font-semibold rounded-sm cursor-pointer hover:bg-stone-800 dark:hover:bg-slate-300 transition-none disabled:opacity-60 disabled:cursor-not-allowed">
            <span wire:loading.remove wire:target='storePassword'>Update</span>
            <span wire:loading wire:target='storePassword' class="flex items-center justify-center gap-2">Updating password...</span>
        </button>
    </div>
