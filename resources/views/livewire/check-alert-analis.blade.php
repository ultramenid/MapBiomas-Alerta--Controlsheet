<div class="glass rounded-sm p-5 mb-5 z-20 relative dark:text-slate-400">
    <div class="text-sm mb-6">
        ...
        <div class="mt-2">
            <input class="bg-white dark:bg-slate-900 border border-stone-300 dark:border-slate-600 text-stone-900 dark:text-slate-100 w-52 rounded-sm px-3 py-2 text-sm focus:outline-none transition-none" wire:model.live='searchName' placeholder="validator name">
        </div>
    </div>
        ...
        <table class="w-full border-collapse">
          <thead class="text-xs font-semibold">
            <tr class="text-left">
              ...
              <th wire:click='sortingField("approved")' class="cursor-pointer border-b border-stone-300 dark:border-slate-700 dark:border-slate-800 px-2 py-2 capitalize ">Aprroved</th>
              <th wire:click='sortingField("reexportimage")' class="cursor-pointer border-b border-stone-300 dark:border-slate-700 dark:border-slate-800 px-2 py-2 capitalize">reexportimage</th>
              <th wire:click='sortingField("reclassification")' class="cursor-pointer border-b border-stone-300 dark:border-slate-700 dark:border-slate-800 px-2 py-2 capitalize">reclassification</th>
              <th wire:click='sortingField("rejected")' class="cursor-pointer border-b border-stone-300 dark:border-slate-700 dark:border-slate-800 px-2 py-2 capitalize">Rejected</th>
              <th wire:click='sortingField("duplicate")' class="cursor-pointer border-b border-stone-300 dark:border-slate-700 dark:border-slate-800 px-2 py-2 capitalize">Duplicate</th>
              <th wire:click='sortingField("preapproved")' class="cursor-pointer border-b border-stone-300 dark:border-slate-700 dark:border-slate-800 px-2 py-2 capitalize">pre-approved</th>
              <th wire:click='sortingField("refined")' class="cursor-pointer border-b border-stone-300 dark:border-slate-700 dark:border-slate-800 px-2 py-2 capitalize">refined</th>
              <th class="cursor-pointer border-b border-stone-300 dark:border-slate-700 dark:border-slate-800 px-2 py-2 capitalize">Sccon</th>
              <th class="cursor-pointer border-b border-stone-300 dark:border-slate-700 dark:border-slate-800 px-2 py-2 capitalize">Workspace</th>
              <th wire:click='sortingField("total")' class="cursor-pointer border-b border-stone-300 dark:border-slate-700 dark:border-slate-800 px-2 py-2 capitalize">TOTAL</th>
            </tr>
          </thead>
