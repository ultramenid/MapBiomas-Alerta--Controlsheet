<div class="glass rounded-sm p-5 mb-5 max-w-3xl mx-auto relative z-20 dark:text-slate-400">
    <div class="flex justify-between">
        <h1 class="text-label text-stone-900 dark:text-slate-100 mt-10 mb-6">Edit alert</h1>
    ...
    <div class="mt-12 flex sm:flex-row flex-col gap-4">
        <div class="sm:w-6/12 w-full">
            ...
            <input
                ...
                disabled
                placeholder="0000000"
                class="bg-stone-200 dark:bg-slate-700 border border-stone-300 dark:border-slate-600 text-stone-900 dark:text-slate-100 w-full rounded-sm px-3 py-2 text-sm focus:outline-none transition-none"
        ...
        <div class="sm:w-6/12 w-full">
            ...
            <input
                ...
                class="bg-white dark:bg-slate-900 border border-stone-300 dark:border-slate-600 text-stone-900 dark:text-slate-100 w-full rounded-sm px-3 py-2 text-sm focus:outline-none transition-none"
    ...
    <div class="mt-4 flex gap-4 sm:flex-row flex-col">
        <div class="sm:w-6/12 w-full">
            <div class="relative flex w-full flex-col text-neutral-600 dark:text-neutral-300">
                <label for="alertStatus" class="text-label text-stone-600 dark:text-slate-400 mb-1">Alert Status</label>
                ...
                <select
                    ...
                    class="w-full appearance-none text-black dark:text-slate-200 border border-stone-300 dark:border-slate-600 dark:border-slate-500 bg-stone-100 dark:bg-slate-800 dark:bg-slate-700 px-4 py-2 text-sm focus:outline-none"
                >
    ...
    <div class="mt-4 flex gap-4 sm:flex-row flex-col">
        ...
        <div class="sm:w-6/12 w-full" x-data="{ open: false }" @click.away="open = false" @region.window="open = false">
            ...
            <div
                @click="open = true"
                class="truncate w-full mb-2 bg-stone-100 dark:bg-slate-800 dark:bg-slate-700 cursor-pointer text-stone-700 dark:text-slate-300 dark:text-slate-300 rounded-sm text-sm border border-stone-300 dark:border-slate-700 dark:border-slate-500 py-2 px-4 focus:outline-none"
            >{{ $region }}</div>
            ...
            >
                <input
                    ...
                    class="w-full mb-4 bg-stone-100 dark:bg-slate-800 dark:bg-slate-700 text-stone-700 dark:text-slate-300 dark:text-slate-300 rounded-sm border border-stone-300 dark:border-slate-700 dark:border-slate-500 py-2 px-4 focus:outline-none text-sm"
                >
    ...
    <div class="mt-4 flex gap-4 sm:flex-row flex-col">
        <div class="w-full">
            <div class="relative flex w-full flex-col text-neutral-600 dark:text-neutral-300">
                <label for="platformStatus" class="text-label text-stone-600 dark:text-slate-400 mb-1">Platform Status</label>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                    class="absolute pointer-events-none right-4 top-9 size-5 dark:text-slate-300">
                    <path fill-rule="evenodd" d="M5.22 8.22a.75.75 0 0 1 1.06 0L10 11.94l3.72-3.72a.75.75 0 1 1 1.06 1.06l-4.25 4.25a.75.75 0 0 1-1.06 0L5.22 9.28a.75.75 0 0 1 0-1.06Z" clip-rule="evenodd" />
                </svg>
    ...
    {{-- TinyMCE Note --}}
    <div class="w-full border-stone-300 dark:border-slate-700 dark:border-slate-600 mb-6 mt-6">
        <h1 class="text-label text-stone-600 dark:text-slate-400 mb-1">Note</h1>
        <div
            x-data="{
