<div class="max-w-3xl mx-auto py-12 px-4 relative z-20 bg-gray-50 mt-4">
    <div class="flex justify-between">
        <h1 class="font-semibold text-3xl mt-10 mb-6 text-gray-700">Add alert</h1>
        <div class="flex justify-end items-center mt-4">
            <button wire:click='storeAlert' class="bg-black py-2 px-4 text-white w-32 cursor-pointer h-10">Save</button>
        </div>
    </div>
    ...
    <div class="mt-12 flex sm:flex-row flex-col gap-4">
        <div class="sm:w-6/12 w-full">
            ...
            <input placeholder="0000000"  type="number"  class=" text-sm bg-gray-100 border border-gray-200 text-gray-600  w-full  py-2 px-4 focus:outline-none  "  wire:model.defer='alertId' placeholder="">
        </div>
        <div class="sm:w-6/12 w-full">
