    ...
    <div class="flex gap-4 sm:flex-row flex-col mt-4 items-end justify-between">
        ...
        <div class="relative">
            ...
            >
                ...
                <a class="text-label text-stone-600 dark:text-slate-400">Excel</a>
            </div>
                    ...
                    <td class="px-6 py-2 break-words text-xs text-stone-700 dark:text-slate-300" wire:key="alert-{{ $item->alertId }}">
                        @if (in_array($item->auditorStatus, ['pre-approved', 'refined', 'error']))
                            <a onclick="window.dispatchEvent(
                                ...
                                @elseif($item->auditorStatus == 'refined') bg-[rgb(135,190,211)]/20 dark:bg-[rgb(135,190,211)]/30 text-[rgb(70,130,150)] dark:text-[rgb(180,220,235)] border border-[rgb(135,190,211)]/40 dark:border-[rgb(135,190,211)]/50 cursor-pointer
